...
// Контент сайта-визитки. Единый источник для CLI-сида (prisma/seed.ts)
// и рантайм-сида на старте (seed.service.ts).

export const experiences: Prisma.ExperienceCreateInput[] = [
  {
